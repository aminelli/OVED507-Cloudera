...
docker run -d --name hdp-namenode --hostname hdp-namenode --network net-hadoop -p 9870:9870 -p 9000:9000 -v hadoop_namenode:/hadoop/dfs/name --env-file hadoop.env -e CLUSTER_NAME=test aci-hadoop:3.4.1-namenode
